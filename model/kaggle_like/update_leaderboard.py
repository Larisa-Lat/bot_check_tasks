...
LB_COLUMNS = ['position', 'datetime', 'username', 'score', 'notebook']
...
async def add_in_leaderboard(values, case, username: str, score: float, notebook: str):
    ...
    leaderboard.loc[len(leaderboard.index)] = [0, current_datetime, username, score, notebook]
